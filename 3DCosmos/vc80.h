...
/* [id][propget] */ HRESULT STDMETHODCALLTYPE IVector3D_get_X_Proxy( 
    IVector3D * This,
    /* [retval][out] */ double *pVal);


void __RPC_STUB IVector3D_get_X_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
/* [id][propput] */ HRESULT STDMETHODCALLTYPE IVector3D_put_X_Proxy( 
    IVector3D * This,
    /* [in] */ double pVal);


void __RPC_STUB IVector3D_put_X_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
/* [id][propget] */ HRESULT STDMETHODCALLTYPE IVector3D_get_Y_Proxy( 
    IVector3D * This,
    /* [retval][out] */ double *pVal);


void __RPC_STUB IVector3D_get_Y_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
/* [id][propput] */ HRESULT STDMETHODCALLTYPE IVector3D_put_Y_Proxy( 
    IVector3D * This,
    /* [in] */ double pVal);


void __RPC_STUB IVector3D_put_Y_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
/* [id][propget] */ HRESULT STDMETHODCALLTYPE IVector3D_get_Z_Proxy( 
    IVector3D * This,
    /* [retval][out] */ double *pVal);


void __RPC_STUB IVector3D_get_Z_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
/* [id][propput] */ HRESULT STDMETHODCALLTYPE IVector3D_put_Z_Proxy( 
    IVector3D * This,
    /* [in] */ double pVal);


void __RPC_STUB IVector3D_put_Z_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
/* [id][propget] */ HRESULT STDMETHODCALLTYPE IVector3D_get_Length_Proxy( 
    IVector3D * This,
    /* [retval][out] */ double *pVal);


void __RPC_STUB IVector3D_get_Length_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
/* [id][propput] */ HRESULT STDMETHODCALLTYPE IVector3D_put_Length_Proxy( 
    IVector3D * This,
    /* [in] */ double pVal);


void __RPC_STUB IVector3D_put_Length_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
/* [id][propget] */ HRESULT STDMETHODCALLTYPE ISensor_get_Translation_Proxy( 
    ISensor * This,
    /* [retval][out] */ IVector3D **pVal);


void __RPC_STUB ISensor_get_Translation_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
/* [id][propget] */ HRESULT STDMETHODCALLTYPE ISensor_get_Rotation_Proxy( 
    ISensor * This,
    /* [retval][out] */ IAngleAxis **pVal);


void __RPC_STUB ISensor_get_Rotation_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
/* [id][propget] */ HRESULT STDMETHODCALLTYPE ISensor_get_Device_Proxy( 
    ISensor * This,
    /* [retval][out] */ IDispatch **pVal);


void __RPC_STUB ISensor_get_Device_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
/* [id][propget] */ HRESULT STDMETHODCALLTYPE ISensor_get_Period_Proxy( 
    ISensor * This,
    /* [retval][out] */ double *pVal);


void __RPC_STUB ISensor_get_Period_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
/* [id] */ HRESULT STDMETHODCALLTYPE ISimpleDevice_Connect_Proxy( 
    ISimpleDevice * This);


void __RPC_STUB ISimpleDevice_Connect_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
/* [id] */ HRESULT STDMETHODCALLTYPE ISimpleDevice_Disconnect_Proxy( 
    ISimpleDevice * This);


void __RPC_STUB ISimpleDevice_Disconnect_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
/* [id][propget] */ HRESULT STDMETHODCALLTYPE ISimpleDevice_get_Sensor_Proxy( 
    ISimpleDevice * This,
    /* [retval][out] */ ISensor **pVal);


void __RPC_STUB ISimpleDevice_get_Sensor_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
/* [id][propget] */ HRESULT STDMETHODCALLTYPE ISimpleDevice_get_Keyboard_Proxy( 
    ISimpleDevice * This,
    /* [retval][out] */ IKeyboard **pVal);


void __RPC_STUB ISimpleDevice_get_Keyboard_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
/* [id][propget] */ HRESULT STDMETHODCALLTYPE ISimpleDevice_get_Type_Proxy( 
    ISimpleDevice * This,
    /* [retval][out] */ long *pVal);


void __RPC_STUB ISimpleDevice_get_Type_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
/* [id][propget] */ HRESULT STDMETHODCALLTYPE ISimpleDevice_get_IsConnected_Proxy( 
    ISimpleDevice * This,
    /* [retval][out] */ VARIANT_BOOL *pVal);


void __RPC_STUB ISimpleDevice_get_IsConnected_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
/* [id] */ HRESULT STDMETHODCALLTYPE ISimpleDevice_LoadPreferences_Proxy( 
    ISimpleDevice * This,
    /* [in] */ BSTR PreferencesName);


void __RPC_STUB ISimpleDevice_LoadPreferences_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
#ifndef __Cosmos3D_LIBRARY_DEFINED__
#define __Cosmos3D_LIBRARY_DEFINED__

/* library Cosmos3D */
/* [uuid][version] */ 


EXTERN_C const IID LIBID_Cosmos3D;
...
#endif
#endif /* __Cosmos3D_LIBRARY_DEFINED__ */
