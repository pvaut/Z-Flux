...
/*    float f = function->eval(point->x, point->y, point->z);
    ...
    n->x = function->eval(point->x+delta, point->y, point->z) - function->eval(point->x-delta, point->y, point->z);
    n->y = function->eval(point->x, point->y+delta, point->z) - function->eval(point->x, point->y-delta, point->z);
    n->z = function->eval(point->x, point->y, point->z+delta) - function->eval(point->x, point->y, point->z-delta);
    float f = sqrt(n->x*n->x + n->y*n->y + n->z*n->z);
